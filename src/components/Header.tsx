...
import { FileText, Sparkles, Terminal, Layers, BookOpen, ExternalLink } from "lucide-react";
...
export const Header: React.FC<HeaderProps> = ({ onOpenApiDocs, onOpenFormats }) => {
  return (
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
          ...
          <div>
            <div className="flex items-center space-x-2">
              ...
              <span className="text-[11px] font-medium px-2 py-0.5 rounded-full bg-emerald-50 text-emerald-700 border border-emerald-200/60 flex items-center gap-1">
                <Sparkles className="w-3 h-3 text-emerald-500" /> Tezkor & Aniq
              </span>
            </div>
        ...
        <div className="flex items-center space-x-2 sm:space-x-3">
          ...
          >
            ...
            <span className="hidden sm:inline">Qo'llab-quvvatlanuvchi Formatlar</span>
          ...
          >
            ...
            <span className="hidden sm:inline">API & Integratsiya</span>
          ...
          >
            ...
            <span className="hidden md:inline">GitHub MarkItDown</span>
